  ...
  return (
    <div className="card hover:shadow-md transition-shadow duration-300">
      ...
      <div className="flex items-start space-x-4 mb-6 pb-4 border-b border-gray-200 dark:border-gray-700 transition-colors duration-300">
        <div className="p-2.5 rounded-lg bg-blue-100 dark:bg-blue-900/30 transition-colors duration-300">
          <Type className="h-5 w-5 text-blue-600 dark:text-blue-400 transition-colors duration-300" />
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex justify-end pt-2">
          <button
            ...
            className="btn btn-primary flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed min-w-[160px] justify-center"
          >
