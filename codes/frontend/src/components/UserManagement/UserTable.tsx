                ...
                >
                  <td className="px-4 py-3 transition-colors duration-300">
                    <div className="flex items-center min-w-0">
                      <div className="flex-shrink-0 h-8 w-8 md:h-10 md:w-10 rounded-full bg-primary-100 dark:bg-primary-900/30 flex items-center justify-center transition-colors duration-300">
                      ...
                      <div className="ml-3 min-w-0 flex-1">
                        ...
                        <div className="text-xs text-gray-500 dark:text-gray-400 truncate md:hidden transition-colors duration-300">
                          {user.email}
                        </div>
                  ...
                  <td className="px-4 py-3 whitespace-nowrap hidden md:table-cell transition-colors duration-300">
                    <div className="flex items-center text-sm text-gray-900 dark:text-white transition-colors duration-300">
                  ...
                  <td className="px-4 py-3 whitespace-nowrap transition-colors duration-300">
                    <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium transition-colors duration-300 ${getRoleBadgeColor(user.role)}`}>
                      {getRoleIcon(user.role)}
